...
The product is `maelys-json`; its release mechanics come from maelys-release
...
4. Tag the merge commit: `git tag -s vX.Y.Z -m "maelys-json X.Y.Z"`, then
...
- packaging/homebrew/libmaelys-json.rb.in: placeholders `@URL@`, `@VERSION@`,
